  ...
  <script>
    $(document).ready(function() {
      ...
      $('#exportBtn').on('click', function() {
        ...
        window.location.href = "{{ route('reports.inquiry-history.export') }}?" + formData;
      });
      ...
      function loadInquiries() {
        ...
        $.ajax({
          url: "{{ route('reports.inquiry-history.getData') }}",
          method: 'GET',
      ...
      function renderTable(data, pagination) {
        ...
        data.forEach((inquiry, index) => {
          ...
          const viewUrl = "{{ url('reports/inquiry-history') }}/" + inquiry._id + "/view";
