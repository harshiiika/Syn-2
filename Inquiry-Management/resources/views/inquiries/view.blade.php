      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Employee</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user-group" style="color: #b8bdc7"></i> Batches Assignment</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-book-open" style="color: #b8bdc7"></i> Courses</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user-group fa-flip-horizontal" style="color: #c2c2c2"></i> Batches</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-graduation-cap" style="color: #b8bdc7"></i> Scholarship</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-credit-card" style="color: #b8bdc7"></i> Fees Master</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-wallet" style="color: #b8bdc7"></i> Other Fees Master</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-diagram-project" style="color: #b8bdc7"></i> Branch Management</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-calendar-day" style="color: #b8bdc7"></i> Session</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-calendar-days" style="color: #b8bdc7"></i> Calendar</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user-check" style="color: #b8bdc7"></i> Student Migrate</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-circle-info" style="color: #b8bdc7"></i> Inquiry Management</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user-check" style="color: #b8bdc7"></i> Student Onboard</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user-check" style="color: #b8bdc7"></i> Pending Fees Students</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user-check" style="color: #b8bdc7"></i> Students</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-credit-card" style="color: #b8bdc7"></i> Fees Collection</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Student</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Employee</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Units</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Dispatch Material</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Test Master</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu">
                <li><a href="#" class="item"><i class="fa-solid fa-user" style="color: #b8bdc7"></i> Walk In</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-calendar-days" style="color: #b8bdc7"></i> Attendance</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-file" style="color: #b8bdc7"></i> Test Series</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-file" style="color: #b8bdc7"></i> Inquiry History</a></li>
                <li><a href="#" class="item"><i class="fa-solid fa-file" style="color: #b8bdc7"></i> Onboard History</a></li>
              </ul>
            </div>
          </div>
        </div>
