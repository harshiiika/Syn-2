    ...
    <div class="right" id="right">
      <div class="attendance-header">
        ...
        <div class="filters-container">
          ...
          <input type="month" class="filter-month" id="monthFilter" value="<?php echo e(date('Y-m')); ?>">
        </div>
      </div>

      <div class="tab-container">
        <a href="<?php echo e(route('attendance.employee.index')); ?>" class="tab-btn">Daily</a>
...
function loadMonthlyData() {
    ...
    $.ajax({
        url: '<?php echo e(route("attendance.employee.monthly.data")); ?>',
        method: 'GET',
        data: {
            page: currentPage,
            per_page: perPage,
...
function showEmployeeDetails(employeeId, employeeName) {
    ...
    $.ajax({
        url: '<?php echo e(route("attendance.employee.monthly.details")); ?>',
        method: 'GET',
        data: {
...
</html><?php /**PATH C:\Users\Priyanshi Rathore\Syn-2\resources\views/attendance/employee/monthly.blade.php ENDPATH**/ ?>