...
<head>
  ...
  <title>Update Student - <?php echo e($student->student_name ?? $student->name); ?></title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.2/css/all.min.css">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo e(asset('css/smstudents.css')); ?>">
  <style>
    .edit-container {
  ...
  <div class="accordion-item">
    ...
    <div class="right" id="right">
      ...
      <div class="page-header">
        ...
        <a href="<?php echo e(route('smstudents.index')); ?>" class="back-link">
      ...
      <div class="form-container">
        <form method="POST" action="<?php echo e(route('smstudents.update', $student->_id ?? $student->id)); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-section">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="student_name" class="form-control" value="<?php echo e(old('student_name', $student->student_name ?? $student->name)); ?>" required>
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="date" name="dob" class="form-control" value="<?php echo e(old('dob', $student->dob)); ?>">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="father_contact" class="form-control" value="<?php echo e(old('father_contact', $student->father_contact)); ?>" maxlength="15">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Father Whatsapp Number</label>
                <input type="text" name="father_whatsapp" class="form-control" value="<?php echo e(old('father_whatsapp', $student->father_whatsapp)); ?>" maxlength="15">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="mother_contact" class="form-control" value="<?php echo e(old('mother_contact', $student->mother_contact)); ?>" maxlength="15">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Student Contact No</label>
                <input type="text" name="phone" class="form-control" value="<?php echo e(old('phone', $student->phone)); ?>" required maxlength="15">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="father_caste" class="form-control" value="<?php echo e(old('father_caste', $student->father_caste ?? 'TEACHER')); ?>">
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <select name="state" class="form-select">
                  ...
                  <option value="Rajasthan" <?php echo e(($student->state ?? '') == 'Rajasthan' ? 'selected' : ''); ?>>Rajasthan</option>
                  <option value="Delhi" <?php echo e(($student->state ?? '') == 'Delhi' ? 'selected' : ''); ?>>Delhi</option>
                  <option value="Maharashtra" <?php echo e(($student->state ?? '') == 'Maharashtra' ? 'selected' : ''); ?>>Maharashtra</option>
                  <option value="Gujarat" <?php echo e(($student->state ?? '') == 'Gujarat' ? 'selected' : ''); ?>>Gujarat</option>
              ...
              <div class="col-md-6 mb-3">
                ...
                <select name="city" class="form-select">
                  ...
                  <option value="Bikaner" <?php echo e(($student->city ?? '') == 'Bikaner' ? 'selected' : ''); ?>>Bikaner</option>
                </select>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="pincode" class="form-control" value="<?php echo e(old('pincode', $student->pincode)); ?>" maxlength="6">
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <div class="radio-group">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="belongs_other_city" value="Yes" <?php echo e(($student->belongs_other_city ?? '') == 'Yes' ? 'checked' : ''); ?>>
                    <label class="form-check-label">Yes</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="belongs_other_city" value="No" <?php echo e(($student->belongs_other_city ?? 'No') == 'No' ? 'checked' : ''); ?>>
          ...
          <div class="form-section">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <select name="previous_class" class="form-select">
                  ...
                  <option value="12th (XII)" <?php echo e(($student->previous_class ?? '') == '12th (XII)' ? 'selected' : ''); ?>>12th (XII)</option>
                  <option value="11th (XI)" <?php echo e(($student->previous_class ?? '') == '11th (XI)' ? 'selected' : ''); ?>>11th (XI)</option>
                  <option value="10th (X)" <?php echo e(($student->previous_class ?? '') == '10th (X)' ? 'selected' : ''); ?>>10th (X)</option>
                </select>
              </div>
              <div class="col-md-6 mb-3">
                ...
                <select name="academic_medium" class="form-select">
                  ...
                  <option value="English" <?php echo e(($student->academic_medium ?? '') == 'English' ? 'selected' : ''); ?>>English</option>
                  <option value="Hindi" <?php echo e(($student->academic_medium ?? '') == 'Hindi' ? 'selected' : ''); ?>>Hindi</option>
                </select>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="school_name" class="form-control" value="<?php echo e(old('school_name', $student->school_name)); ?>">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Board</label>
                <select name="academic_board" class="form-select">
                  <option value="">Select Board</option>
                  <option value="RBSE" <?php echo e(($student->academic_board ?? '') == 'RBSE' ? 'selected' : ''); ?>>RBSE</option>
                  <option value="CBSE" <?php echo e(($student->academic_board ?? '') == 'CBSE' ? 'selected' : ''); ?>>CBSE</option>
                  <option value="ICSE" <?php echo e(($student->academic_board ?? '') == 'ICSE' ? 'selected' : ''); ?>>ICSE</option>
                </select>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="passing_year" class="form-control" value="<?php echo e(old('passing_year', $student->passing_year)); ?>" maxlength="4">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Percentage</label>
                <input type="text" name="percentage" class="form-control" value="<?php echo e(old('percentage', $student->percentage)); ?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="mb-3">
                ...
                <?php if(isset($student->passport_photo) && !empty($student->passport_photo)): ?>
                    <div class="current-file-info">
                        <small class="text-muted">
                            <i class="fas fa-check-circle text-success"></i> Current file: 
                            <a href="<?php echo e(is_array($student->passport_photo) ? $student->passport_photo[0] : $student->passport_photo); ?>" target="_blank" class="text-primary">View</a>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if(isset($student->marksheet) && !empty($student->marksheet)): ?>
                    <div class="current-file-info">
                        <small class="text-muted">
                            <i class="fas fa-check-circle text-success"></i> Current file: 
                            <a href="<?php echo e(is_array($student->marksheet) ? $student->marksheet[0] : $student->marksheet); ?>" target="_blank" class="text-primary">View</a>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if(isset($student->caste_certificate) && !empty($student->caste_certificate)): ?>
                    <div class="current-file-info">
                        <small class="text-muted">
                            <i class="fas fa-check-circle text-success"></i> Current file: 
                            <a href="<?php echo e(is_array($student->caste_certificate) ? $student->caste_certificate[0] : $student->caste_certificate); ?>" target="_blank" class="text-primary">View</a>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if(isset($student->scholarship_proof) && !empty($student->scholarship_proof)): ?>
                    <div class="current-file-info">
                        <small class="text-muted">
                            <i class="fas fa-check-circle text-success"></i> Current file: 
                            <a href="<?php echo e(is_array($student->scholarship_proof) ? $student->scholarship_proof[0] : $student->scholarship_proof); ?>" target="_blank" class="text-primary">View</a>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if(isset($student->secondary_marksheet) && !empty($student->secondary_marksheet)): ?>
                    <div class="current-file-info">
                        <small class="text-muted">
                            <i class="fas fa-check-circle text-success"></i> Current file: 
                            <a href="<?php echo e(is_array($student->secondary_marksheet) ? $student->secondary_marksheet[0] : $student->secondary_marksheet); ?>" target="_blank" class="text-primary">View</a>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if(isset($student->senior_secondary_marksheet) && !empty($student->senior_secondary_marksheet)): ?>
                    <div class="current-file-info">
                        <small class="text-muted">
                            <i class="fas fa-check-circle text-success"></i> Current file: 
                            <a href="<?php echo e(is_array($student->senior_secondary_marksheet) ? $student->senior_secondary_marksheet[0] : $student->senior_secondary_marksheet); ?>" target="_blank" class="text-primary">View</a>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
...
</html><?php /**PATH C:\Users\dhamu\Syn-2\resources\views/student/smstudents/edit.blade.php ENDPATH**/ ?>