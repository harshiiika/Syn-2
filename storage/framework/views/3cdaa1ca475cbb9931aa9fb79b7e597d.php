    ...
    <div class="right" id="right">
      ...
      <div class="whole">
        ...
        <div class="row" id="testMasterGrid">
          <?php $__empty_1 = true; $__currentLoopData = $testMasters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $master): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-6 col-lg-4 mb-4 test-master-item" data-searchable="<?php echo e(strtolower($master['name'])); ?>">
              <div class="test-master-card" onclick="window.location.href='<?php echo e(route('test_series.show', urlencode($master['name']))); ?>'">
                <div class="test-master-header">
                  <i class="fas fa-graduation-cap"></i>
                  <div>
                    <div class="test-master-title"><?php echo e($master['name']); ?></div>
                  </div>
                </div>
                ...
                <div class="test-counts-container">
                  <div class="test-count">
                    ...
                    <span class="test-count-value"><?php echo e($master['type1_count']); ?></span>
                  </div>
                  <div class="test-count">
                    <span class="test-count-label">
                      <i class="fas fa-clipboard-check me-1"></i>Type2 TestSeries
                    </span>
                    <span class="test-count-value"><?php echo e($master['type2_count']); ?></span>
                  </div>
                </div>
              </div>
            </div>
...
</html><?php /**PATH C:\Users\DELL\Syn-2\User_Management\resources\views/test_series/index.blade.php ENDPATH**/ ?>