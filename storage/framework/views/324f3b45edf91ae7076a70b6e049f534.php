  ...
  <div class="accordion-item">
    ...
    <div class="right" id="right">
      ...
      <div class="tab-container">
        <a href="<?php echo e(route('attendance.student.index')); ?>" class="tab-btn">Daily</a>
...
function loadMonthlyData() {
    ...
    $.ajax({
        url: '<?php echo e(route("attendance.student.monthly.data")); ?>',
        method: 'GET',
        data: {
            page: currentPage,
            per_page: perPage,
...
function showStudentDetails(studentId, studentName) {
    ...
    $.ajax({
        url: '<?php echo e(route("attendance.student.monthly.details")); ?>',
        method: 'GET',
        data: {
...
</html><?php /**PATH C:\Users\Priyanshi Rathore\Syn-2\resources\views/attendance/student/monthly.blade.php ENDPATH**/ ?>