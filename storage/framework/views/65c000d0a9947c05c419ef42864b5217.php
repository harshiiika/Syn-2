...
<tbody>
  ...
  <input type="date" 
         class="form-control" 
         name="start_date" 
         value="<?php echo e($batch->start_date ? \Carbon\Carbon::parse($batch->start_date)->format('Y-m-d') : ''); ?>"
         required>
</div>
  ...
  <input type="date" 
         ...
         value="<?php echo e($batch->installment_date_2 ? \Carbon\Carbon::parse($batch->installment_date_2)->format('Y-m-d') : ''); ?>">
</div>
...
<div class="mb-3">
  ...
  <input type="date" 
         ...
         value="<?php echo e($batch->installment_date_3 ? \Carbon\Carbon::parse($batch->installment_date_3)->format('Y-m-d') : ''); ?>">
</div>
                    <!-- Status -->
                    <div class="mb-3">
