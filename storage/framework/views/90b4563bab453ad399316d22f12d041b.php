  ...
  <div class="main-container">
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu" id="dropdown-body">
                <li><a class="item active" href="<?php echo e(route('attendance.employee.index')); ?>"><i class="fa-solid fa-circle-info" id="side-icon"></i> Employee</a></li>
    ...
    <div class="right" id="right">
      ...
      <div class="tab-container">
        ...
        <a href="<?php echo e(route('attendance.employee.monthly')); ?>" class="tab-btn" id="monthlyTab">Monthly</a>
      </div>
      ...
      <div class="content-card">
        <div class="list-header-section">
          <h6 class="list-title">List of Staff: <span id="selectedDate"><?php echo e(date('M d, Y')); ?></span></h6>
...
function loadAttendanceData() {
    ...
    $.ajax({
        url: '<?php echo e(route("attendance.employee.data")); ?>',
        method: 'GET',
        data: {
            page: currentPage,
            per_page: perPage,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            checkedIds.forEach(function(employeeId, index) {
                ...
                $.ajax({
                    url: '<?php echo e(route("attendance.employee.mark")); ?>',
                    method: 'POST',
                    data: {
...
</html><?php /**PATH C:\Users\Priyanshi Rathore\Syn-2\resources\views/attendance/employee/index.blade.php ENDPATH**/ ?>