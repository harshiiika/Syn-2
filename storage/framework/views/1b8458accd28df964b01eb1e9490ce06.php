  ...
  <div class="dd">
    <div class="line">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="<?php echo e(route('student.onboard.onboard', ['per_page' => 5, 'search' => request('search')])); ?>">5</a></li>
          <li><a class="dropdown-item" href="<?php echo e(route('student.onboard.onboard', ['per_page' => 10, 'search' => request('search')])); ?>">10</a></li>
          <li><a class="dropdown-item" href="<?php echo e(route('student.onboard.onboard', ['per_page' => 25, 'search' => request('search')])); ?>">25</a></li>
          <li><a class="dropdown-item" href="<?php echo e(route('student.onboard.onboard', ['per_page' => 50, 'search' => request('search')])); ?>">50</a></li>
          <li><a class="dropdown-item" href="<?php echo e(route('student.onboard.onboard', ['per_page' => 100, 'search' => request('search')])); ?>">100</a></li>
        </ul>
      </div>
    </div>
    <div class="search">
      <form method="GET" action="<?php echo e(route('student.onboard.onboard')); ?>" id="searchForm">
      ...
      <tr>
        <td colspan="8" class="text-center py-4">
          <?php if(request('search')): ?>
            ...
            <a href="<?php echo e(route('student.onboard.onboard')); ?>" class="btn btn-sm btn-outline-secondary mt-2">
...
<div class="footer">
  <div class="left-footer">
    <p>Showing <?php echo e($students->firstItem() ?? 0); ?> to <?php echo e($students->lastItem() ?? 0); ?> of <?php echo e($students->total()); ?> entries
      <?php if(request('search')): ?>
        <span class="text-muted">(filtered from <?php echo e(\App\Models\Student\Onboard::count()); ?> total entries)</span>
      <?php endif; ?>
    </p>
  </div>
...
</html><?php /**PATH C:\Users\Priyanshi Rathore\Syn-2\resources\views/student/onboard/onboard.blade.php ENDPATH**/ ?>