...
{
    /**
     * Display PENDING INQUIRY students with search and pagination
...
public function index(Request $request)
    {
        ...
        // Build the query - only show students with "pending_fees" status
        $query = Student::where('status', 'pending_fees');
        ...
        return view('student.student.pending', compact('students', 'search'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            // Handle file uploads and preserve existing documents
            $fileFields = [
                'passport_photo',
                'marksheet', 
                'caste_certificate',
    ...
    public function transferToOnboard(Request $request, $id)
    {
        try {
            ...
            // 1. Get history from pending student
