    ...
    <div class="left" id="sidebar">
      <div class="text" id="text">
       ...
       <div class="accordion accordion-flush" id="accordionFlushExample">
        <!-- Sidebar content (keeping it same as yours) -->
          ...
          <div id="flush-collapseFour" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu" id="dropdown-body">
                <li><a class="item active" href="{{ route('student.student.pending') }}"><i class="fa-solid fa-user-check" id="side-icon"></i>Student Onboard</a></li>
                <li><a class="item" href="{{ route('student.onboard.onboard') }}"><i class="fa-solid fa-user-check" id="side-icon"></i>Onboarding Students</a></li>
