...
<body>
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          <li><a class="item" href="{{ route('user.emp.emp') }}">
    ...
    <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          ...
          <li><a class="item" href="{{ route('master.scholarship.index') }}">
            <i class="fa-solid fa-graduation-cap" id="side-icon"></i> Scholarship</a>
          </li>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
        ...
        id="accordion-button">
        <i class="fa-solid fa-calendar-day" id="side-icon"></i> Session Management
      </button>
    </h2>
      ...
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          ...
          <li><a class="item" href="{{ route('student.student.pending') }}">
            <i class="fa-solid fa-user-plus" id="side-icon"></i> Student Onboard</a>
          </li>
          <li><a class="item" href="{{ route('student.pendingfees.pending') }}">
            <i class="fa-solid fa-clock" id="side-icon"></i> Pending Fees Students</a>
          </li>
          <li><a class="item" href="{{ route('student.onboard.index') }}">
            <i class="fa-solid fa-user-check" id="side-icon"></i> Active Students</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          <li><a class="item" href="{{ route('fees.index') }}">
            <i class="fa-solid fa-money-bill-wave" id="side-icon"></i> Fees Collection</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          <li><a class="item" href="/attendance-management/students">
            <i class="fa-solid fa-user-check" id="side-icon"></i> Student Attendance</a>
          </li>
          <li><a class="item" href="/attendance-management/employee">
            <i class="fa-solid fa-user-tie" id="side-icon"></i> Employee Attendance</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          <li><a class="item" href="/study-material/units">
            <i class="fa-solid fa-book" id="side-icon"></i> Units</a>
          </li>
          <li><a class="item" href="/study-material/dispatch">
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          <li><a class="item" href="/test-series/master">
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
        <ul class="menu" id="dropdown-body">
          <li><a class="item" href="/reports/walk-in">
            <i class="fa-solid fa-person-walking" id="side-icon"></i> Walk In</a>
          </li>
          <li><a class="item" href="/reports/attendance">
            <i class="fa-solid fa-calendar-check" id="side-icon"></i> Attendance</a>
          </li>
          <li><a class="item" href="/reports/test-series">
            <i class="fa-solid fa-chart-line" id="side-icon"></i> Test Series</a>
          </li>
          <li><a class="item" href="{{ route('inquiries.index') }}">
            <i class="fa-solid fa-file-lines" id="side-icon"></i> Inquiry History</a>
          </li>
          <li><a class="item" href="/reports/onboard">
            <i class="fa-solid fa-file-invoice" id="side-icon"></i> Onboard History</a>
          </li>
        </ul>
      </div>
    </div>
