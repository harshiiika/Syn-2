  ...
  <div class="accordion-item">
    ...
    <div class="right" id="right">
      <div class="top">
        ...
        <a href="<?php echo e(route('smstudents.export')); ?>" class="btn btn-success">
          Export
        </a>
      </div>
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="actionDropdown<?php echo e($studentId); ?>">
                      ...
                      <?php if(($student->status ?? 'active') === 'active'): ?>
                        ...
                        <li>
<button class="dropdown-item open-batch-modal" data-student-id="<?php echo e($studentId); ?>">Batch Update</button>                        <li>
                          <!-- <button class="dropdown-item" type="button" data-bs-toggle="modal"
                            data-bs-target="#shiftModal<?php echo e($studentId); ?>">
                            Shift Update
                          </button> -->
...
</html><?php /**PATH C:\Users\dhamu\Syn-2\User_Management\resources\views/student/smstudents/smstudents.blade.php ENDPATH**/ ?>