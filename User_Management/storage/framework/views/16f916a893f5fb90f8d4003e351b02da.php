...
<div class="accordion accordion-flush" id="accordionFlushExample">
  ...
  <div class="accordion-item">
    ...
    function performCollectSearch() {
        ...
        $.post('<?php echo e(route("fees.collect.search")); ?>', { search: term }, function(r) {
    ...
    function loadAllTransactions() {
        ...
        $.post('<?php echo e(route("fees.transaction.filter")); ?>', { from_date: from, to_date: to }, function(r) {
            if (r.success && r.data && r.data.length) {
    ...
    function filterTransactions() {
        ...
        $('#transactionResults').html('<div class="loading-state"><div class="spinner"></div><p>Loading...</p></div>');
        $.post('<?php echo e(route("fees.transaction.filter")); ?>', { from_date: from, to_date: to }, r => {
            if (r.success && r.data && r.data.length) {
                renderTransactions(r.data);
                transactionsLoaded = true;
            } else {
...
</html><?php /**PATH C:\Users\dhamu\Syn-2\User_Management\resources\views/fees_management/index.blade.php ENDPATH**/ ?>