...
<body>
      ...
      <div class="modal-content">
        ...
        <form id="unitForm">
          <div class="modal-body">
            ...
            <input type="hidden" id="session" name="session" value="<?php echo e(session('selected_session', '2025-2026')); ?>">
            <div class="mb-3">
  ...
  $(document).ready(function() {
      let table;
      let currentSession = '<?php echo e(session("selected_session", "2025-2026")); ?>';
      ...
      function initDataTable() {
          table = $('#unitsTable').DataTable({
              ...
              serverSide: true,
              ajax: {
                  url: '<?php echo e(route("units.getData")); ?>',
                  type: 'GET',
                  data: function(d) {
...
</html><?php /**PATH C:\Users\dhamu\Syn-2\User_Management\resources\views/study_material/unit.blade.php ENDPATH**/ ?>