  ...
  <div class="header">
    ...
    <div class="pfp">
      <div class="session">
        <h5>Session:</h5>
        <select>
          <option><?php echo e(session('selected_session', '2025-2026')); ?></option>
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu" id="dropdown-body">
                <li><a class="item" href="<?php echo e(route('fees.management.index')); ?>"><i class="fa-solid fa-money-bill-wave" id="side-icon"></i>Fees Collection</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">
              <ul class="menu" id="dropdown-body">
                <li><a class="item" href="<?php echo e(route('units.index')); ?>"><i class="fa-solid fa-book" id="side-icon"></i>Units</a></li>
                <li><a class="item active" href="<?php echo e(route('dispatch.index')); ?>"><i class="fa-solid fa-truck" id="side-icon"></i>Dispatch Material</a></li>
              </ul>
            </div>
          </div>
        </div>
...
</html><?php /**PATH C:\Users\dhamu\Syn-2\User_Management\resources\views/study_material/Dispatch.blade.php ENDPATH**/ ?>